...
var listCmd = &cobra.Command{
	Use:     ListCmdLiteral,
	Short:   "List all LLM proxies in a project",
	Long:    "Retrieves all LLM proxies for a given project from the WSO2 API Platform AI workspace.",
...
func runListCommand() error {
	...
	path := aiworkspace.ProxyListPath(projectID, aiworkspace.ListQuery{Limit: listLimit, Offset: listOffset})

	resp, err := client.Get(path)
	if err != nil {
		return aiworkspace.WrapRequestError("list llm proxies", err, listInsecure)
	}
