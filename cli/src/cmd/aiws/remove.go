...
var removeCmd = &cobra.Command{
	...
	Short:   "Remove an AI workspace",
	Long:    "Remove an AI workspace configuration from the ap config file.",
...
func init() {
	utils.AddStringFlag(removeCmd, utils.FlagName, &removeName, "", "Name of the AI workspace to remove (required)")
...
func runRemoveCommand() error {
	...
	if err := cfg.RemoveAIWorkspaceFromPlatform(resolvedPlatform, removeName); err != nil {
		return err
	}
	...
	fmt.Println("AI workspace removed successfully.")
