...
const (
	...
	DeleteCmdExample = `# Delete an organization using the active devportal
ap devportal org delete --org org_1

# Delete an organization using a specific devportal
...
var deleteCmd = &cobra.Command{
	...
	Short:   "Delete a DevPortal organization",
	Long:    "Deletes a specific organization from the selected DevPortal.",
