...
#                     value: CustomValue
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-set-req/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-append-req/v0/health" to be ready
...
#                     name: User-Agent
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-delete-req/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-multiple-req/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-replace-req/v0/health" to be ready
...
#                     value: test-value
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-case-req/v0/health" to be ready
...
#                     value: processed
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-set-resp/v0/health" to be ready
...
#                     value: gateway-2
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-append-resp/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-delete-resp/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-multiple-resp/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-both/v0/health" to be ready
...
#                     name: X-Powered-By
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-security/v0/health" to be ready
...
#                     value: "3600"
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-cors/v0/health" to be ready
...
#                     value: "1640995200"
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-ratelimit/v0/health" to be ready
...
#                     value: ""
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-empty/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-delete-none/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-special/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-long/v0/health" to be ready
...
#                     value: test-value
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-only-req/v0/health" to be ready
...
#                     value: test-value
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-only-resp/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-tracking/v0/health" to be ready
...
#                     value: test-value-2
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-names/v0/health" to be ready
...
#                     value: final-value
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-multi-set/v0/health" to be ready
...
#                     value: processed
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-content/v0/health" to be ready
...
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-auth/v0/health" to be ready
...
#                     value: "false"
#       """
#     And I wait for the endpoint "http://localhost:8080/modify-headers-version/v0/health" to be ready
