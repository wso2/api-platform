...
func (c *Config) Validate() error {
	...
	if c.Controller.Server.TLS.Enabled && c.Controller.PolicyServer.Port == c.Controller.Server.TLS.Port {
		return fmt.Errorf("policy_server.port cannot be same as server.tls.port")
	}
	if c.Controller.AdminServer.Enabled && c.Controller.PolicyServer.Port == c.Controller.AdminServer.Port {
		return fmt.Errorf("policy_server.port cannot be same as admin_server.port")
	}
	if c.Controller.Metrics.Enabled && c.Controller.PolicyServer.Port == c.Controller.Metrics.Port {
		return fmt.Errorf("policy_server.port cannot be same as metrics.port")
	}
