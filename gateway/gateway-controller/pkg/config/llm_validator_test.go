...
// TestValidateLLMProxy_ProviderAuth covers validateLLMUpstreamAuth, the LlmProxy-side
// counterpart to LlmProvider's upstream.auth handling.
...
// TestValidateLLMProxy_AdditionalProviderAuth covers the second validateLLMUpstreamAuth
// call site: spec.additionalProviders[].auth.
