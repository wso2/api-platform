...
### Router (Envoy Proxy)
Based on `envoyproxy/envoy:v1.39.0`. Handles all inbound traffic, performs dynamic routing, and delegates request/response processing to the Policy Engine via the `ext_proc` filter.
