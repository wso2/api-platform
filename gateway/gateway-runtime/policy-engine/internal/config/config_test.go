...
func TestValidateAdminTLSVersions(t *testing.T) {
	...
	t.Run("minimum TLS1_0 rejected", func(t *testing.T) {
		err := ValidateAdminTLSVersions("TLS1_0", "TLS1_3")
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "minimum_protocol_version")
	})

	t.Run("minimum TLS1_1 rejected", func(t *testing.T) {
		err := ValidateAdminTLSVersions("TLS1_1", "TLS1_3")
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "minimum_protocol_version")
	})
...
// TestValidate_AnalyticsPayloadMigration_SkippedWhenAnalyticsDisabled guards
...
func TestValidate_AnalyticsPayloadMigration_SkippedWhenAnalyticsDisabled(t *testing.T) {
	cfg := validConfig()
	cfg.Analytics.Enabled = false
