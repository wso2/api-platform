...
| `kind` | TEXT | No | (required) | API type from configuration (e.g., "RestApi", "graphql") |
...
INSERT INTO deployments (
    ...
    '/weather',
    'RestApi',
    '{"version":"gateway.api-platform.wso2.com/v1","kind":"RestApi","data":{"name":"Weather API","version":"v1.0","context":"/weather","upstream":[{"url":"http://api.weather.com"}],"operations":[{"method":"GET","path":"/{country}/{city}"}]}}',
    'pending',
...
```json
{
  "version": "gateway.api-platform.wso2.com/v1",
  "kind": "RestApi",
  "data": {
    "name": "Weather API",
    "version": "v1.0",
