...
```bash
curl -k -X POST \
  "https://localhost:9543/api-portal/api/v0.9/views/{viewId}/api-workflows" \
...
```bash
curl -k https://localhost:9543/api-portal/api/v0.9/views/{viewId}/api-workflows \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -k https://localhost:9543/api-portal/api/v0.9/views/{viewId}/api-workflows/{apiWorkflowId} \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -k -X PUT \
  "https://localhost:9543/api-portal/api/v0.9/views/{viewId}/api-workflows/{apiWorkflowId}" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
...
```bash
curl -k -X POST \
  "https://localhost:9543/api-portal/api/v0.9/views/{viewId}/api-workflows/generate-prompt" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
