...
# OpenAPI YAML
curl -k -X PUT \
  "https://localhost:9543/api-portal/api/v0.9/apis/{apiId}" \
  -H "Authorization: Bearer $TOKEN" \
...
```bash
curl -k -X PUT https://localhost:9543/api-portal/api/v0.9/apis/{apiId} \
  -H "Authorization: Bearer $TOKEN" \
...
```bash
curl -k -X DELETE https://localhost:9543/api-portal/api/v0.9/apis/{apiId} \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -k https://localhost:9543/api-portal/api/v0.9/apis -H "Authorization: Bearer $TOKEN"
```

## Get an API

```bash
curl -k https://localhost:9543/api-portal/api/v0.9/apis/{apiId} -H "Authorization: Bearer $TOKEN"
```
