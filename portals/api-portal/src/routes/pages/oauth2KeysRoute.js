...
const oauth2KeysPageController = require('../../controllers/oauth2KeysPageController');
...
router.get('/:orgName/views/:viewName/oauth2-keys', (req, res, next) => {
    if (req.params.orgName === 'favicon.ico') {
        return res.status(404).send('Not Found');
    }
    next();
}, registerPartials, ensureAuthenticated, oauth2KeysPageController.loadOAuth2Keys);
