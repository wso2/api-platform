...
export const SCOPES = {
  ...
  GATEWAY_POLICY_READ:    'ap:gateway:policy:read',
  GATEWAY_POLICY_CREATE:  'ap:gateway:policy:create',
  GATEWAY_POLICY_DELETE:  'ap:gateway:policy:delete',
  GATEWAY_POLICY_MANAGE:  'ap:gateway:policy:manage',
