...
export async function deployMCPServer(
  ...
  try {
    const response = await post<DeploymentResponse>(
      `/mcp-proxies/${encodeURIComponent(mcpServerId)}/deployments`,
      request,
      baseUrl
    );
    return response;
...
export async function getMCPServerDeployments(
  ...
  try {
    ...
    const response = await get<DeploymentListResponse>(
      `/mcp-proxies/${encodeURIComponent(mcpServerId)}/deployments${query ? `?${query}` : ''}`,
      undefined,
      baseUrl
    );
    return response;
...
export async function getMCPServerDeployment(
  ...
  try {
    const response = await get<DeploymentResponse>(
      `/mcp-proxies/${encodeURIComponent(mcpServerId)}/deployments/${encodeURIComponent(deploymentId)}`,
      undefined,
      baseUrl
    );
    return response;
