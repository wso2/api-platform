...
(function () {
    ...
    async function postGenerate(body) {
        const response = await fetch(devportalApi.org(orgId, '/apis/' + encodeURIComponent(apiId) + '/api-keys/generate'), {
    ...
    async function postRegenerate(keyId, body) {
        const response = await fetch(devportalApi.org(orgId, '/apis/' + encodeURIComponent(apiId) + '/api-keys/regenerate'), {
            method: 'POST', credentials: 'same-origin',
    ...
    async function postRevoke(keyId) {
        const response = await fetch(devportalApi.org(orgId, '/apis/' + encodeURIComponent(apiId) + '/api-keys/revoke'), {
            method: 'POST', credentials: 'same-origin',
    ...
    async function postAssociate(keyId, appId) {
        const response = await fetch(devportalApi.org(orgId, '/apis/' + encodeURIComponent(apiId) + '/api-keys/associate'), {
            method: 'POST', credentials: 'same-origin',
    ...
    async function postDissociate(keyId) {
        const response = await fetch(devportalApi.org(orgId, '/apis/' + encodeURIComponent(apiId) + '/api-keys/dissociate'), {
            method: 'POST', credentials: 'same-origin',
            headers: jsonMutationHeaders(), body: JSON.stringify({ keyId: keyId }),
        });
        if (!response.ok) {
