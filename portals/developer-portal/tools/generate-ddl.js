 ...
 *
 *   node tools/generate-ddl.js <dialect>
 *
...
if (!dialect || !SUPPORTED.includes(dialect)) {
    console.error('Usage: node tools/generate-ddl.js <dialect>');
...
// ------------------------------------------------------------------
const lines = [
    '-- Generated by tools/generate-ddl.js — do not edit manually.',
    `-- Dialect: ${dialect}`,
    `-- Re-generate with: make generate-ddl  (or: node tools/generate-ddl.js ${dialect})`,
];
if (dialect === 'postgres') {
