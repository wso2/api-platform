...
role          = "ap_admin"     # grants dp:org_manage, dp:api_manage, … — see roles.yaml
```

To change what a portal user may do, edit that role's entry in `roles.yaml` rather than the user block.
