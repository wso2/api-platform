...
-- Extend DP_APP_KEY_MAPPING for decoupled (non-CP) mode
ALTER TABLE "DP_APP_KEY_MAPPING"
    ADD COLUMN IF NOT EXISTS "KM_ID" VARCHAR(256),
    ADD COLUMN IF NOT EXISTS "AS_CLIENT_ID" VARCHAR(256),
    ADD COLUMN IF NOT EXISTS "KEY_TYPE" VARCHAR(32) DEFAULT 'PRODUCTION';
