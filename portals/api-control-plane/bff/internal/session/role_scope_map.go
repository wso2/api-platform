...
//
// The BFF's counterpart of platform-api's internal/middleware/role_scope_map.go,
// api-portal's src/config/roleScopeMap.js and the AI Workspace BFF's
// internal/session/role_scope_map.go — the same file, in the same shape, read by
// every component that gates on a caller's effective scopes.
//
