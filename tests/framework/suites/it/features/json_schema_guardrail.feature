...
Feature: JSON Schema Guardrail Policy
  ...
  Scenario: Valid request passes schema validation
    ...
    And I send a "GET" request to "/jsg-valid-req/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-valid-req/v1.0.0/check" with body:
      """
  ...
  Scenario: Invalid request fails schema validation
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-invalid-req/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-invalid-req/v1.0.0/check" with body:
      """
      {"name": "John Doe"}
      """
    Then the response status code should be 422
    And the JSON response field "type" should be "JSON_SCHEMA_GUARDRAIL"
    Given I authenticate using basic auth as "admin"
  ...
  Scenario: Missing required field fails validation
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-missing-field/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-missing-field/v1.0.0/check" with body:
      """
      {"username": "johndoe"}
      """
    Then the response status code should be 422
  ...
  Scenario: Wrong type fails validation
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-wrong-type/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-wrong-type/v1.0.0/check" with body:
      """
  ...
  Scenario: Valid response passes schema validation
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/jsg-valid-resp/v1.0.0/echo" until status 200
    Then the response status code should be 200
    Given I authenticate using basic auth as "admin"
  ...
  Scenario: Validate both request and response
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-both-valid/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-both-valid/v1.0.0/check" with body:
      """
      {"input": "test data"}
      """
    Then the response status code should be 200
  ...
  Scenario: Validate specific field with JSONPath
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-jsonpath/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-jsonpath/v1.0.0/check" with body:
      """
  ...
  Scenario: JSONPath extraction with invalid data
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-jsonpath-inv/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-jsonpath-inv/v1.0.0/check" with body:
      """
  ...
  Scenario: Validate nested object with JSONPath
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-nested-jsonpath/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-nested-jsonpath/v1.0.0/check" with body:
      """
  ...
  Scenario: Invert logic passes when schema validation fails
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-invert-pass/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-invert-pass/v1.0.0/check" with body:
      """
  ...
  Scenario: Invert logic blocks when schema validation succeeds
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-invert-block/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-invert-block/v1.0.0/check" with body:
      """
      {"command": "rm -rf /"}
      """
    Then the response status code should be 422
  ...
  Scenario: Block requests matching malicious pattern with invert
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-block-mal/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-block-mal/v1.0.0/check" with body:
      """
  ...
  Scenario: Show detailed assessment on validation failure
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-show-assessment/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-show-assessment/v1.0.0/check" with body:
      """
      {"name": "Jo", "age": 15}
      """
    Then the response status code should be 422
  ...
  Scenario: Hide assessment details when showAssessment is false
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-hide-assessment/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-hide-assessment/v1.0.0/check" with body:
      """
      {"age": 25}
      """
    Then the response status code should be 422
  ...
  Scenario: Validate string length constraints
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-string-length/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-string-length/v1.0.0/check" with body:
      """
      {"username": "ab"}
      """
    Then the response status code should be 422
  ...
  Scenario: Validate numeric range constraints
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-numeric-range/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-numeric-range/v1.0.0/check" with body:
      """
      {"price": -5}
      """
    Then the response status code should be 422
  ...
  Scenario: Validate array constraints
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-array-const/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-array-const/v1.0.0/check" with body:
      """
      {"tags": []}
      """
    Then the response status code should be 422
  ...
  Scenario: Validate enum constraints
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-enum-const/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-enum-const/v1.0.0/check" with body:
      """
  ...
  Scenario: Validate pattern constraints
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-pattern-const/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-pattern-const/v1.0.0/check" with body:
      """
      {"email": "invalid-email"}
      """
    Then the response status code should be 422
  ...
  Scenario: Validate nested object schema
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-nested-obj/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-nested-obj/v1.0.0/check" with body:
      """
  ...
  Scenario: Validate array of objects
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-array-obj/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-array-obj/v1.0.0/check" with body:
      """
  ...
  Scenario: Handle empty request body
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-empty-body/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-empty-body/v1.0.0/check" with body:
      """
      """
    Then the response status code should be 422
    Given I authenticate using basic auth as "admin"
  ...
  Scenario: Handle invalid JSON
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-invalid-json/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-invalid-json/v1.0.0/check" with body:
      """
      not valid json {
      """
    Then the response status code should be 422
  ...
  Scenario: Handle invalid JSONPath
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-invalid-jsonpath/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-invalid-jsonpath/v1.0.0/check" with body:
      """
      {"data": "test"}
      """
    Then the response status code should be 422
  ...
  Scenario: User registration with comprehensive validation
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-registration/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-registration/v1.0.0/check" with body:
      """
  ...
  Scenario: Block SQL injection patterns
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-sql-inject/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-sql-inject/v1.0.0/check" with body:
      """
  ...
  Scenario: E-commerce order validation
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/jsg-ecommerce/v1.0.0/health" until status 200
    When I send a "POST" request to "/jsg-ecommerce/v1.0.0/check" with body:
      """
  ...
  Scenario: API response contract enforcement
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/jsg-resp-contract/v1.0.0/echo" until status 200
    Then the response status code should be 200
    Given I authenticate using basic auth as "admin"
