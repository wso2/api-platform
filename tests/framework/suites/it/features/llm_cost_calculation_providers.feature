...
Feature: LLM cost calculation across provider response shapes
  ...
  # Each provider uses the gateway's built-in template for its provider: llm-cost reads
  # token counts, model, cache, tier, and fee fields from the route's provider template.
  Background:
  ...
  Scenario: Gemini cost calculation triggers rate limit at correct token count
    ...
    Given I generate a unique resource name from "cblp-gemini-provider" and store it as "providerName"
  ...
  Scenario: Anthropic geo and speed multipliers inflate cost correctly
    ...
    Given I generate a unique resource name from "cblp-anthropic-geo-speed-provider" and store it as "providerName"
  ...
  Scenario: Anthropic 1-hour TTL cache writes billed at higher rate
    ...
    Given I generate a unique resource name from "cblp-anthropic-cache1hr-provider" and store it as "providerName"
  ...
  Scenario: Anthropic web search tool per-query cost added to token cost
    ...
    Given I generate a unique resource name from "cblp-anthropic-websearch-provider" and store it as "providerName"
  ...
  Scenario: Gemini context caching - cached tokens billed at reduced rate
    ...
    Given I generate a unique resource name from "cblp-gemini-cached-provider" and store it as "providerName"
  ...
  Scenario: Gemini thinking model - thinking tokens billed at reasoning rate
    ...
    Given I generate a unique resource name from "cblp-gemini-thinking-provider" and store it as "providerName"
  ...
  Scenario: Anthropic cache reads billed at reduced cache read rate
    ...
    Given I generate a unique resource name from "cblp-anthropic-cache-read-provider" and store it as "providerName"
  ...
  Scenario: OpenAI prompt caching - cached tokens billed at reduced rate
    ...
    Given I generate a unique resource name from "cblp-openai-cached-provider" and store it as "providerName"
  ...
  Scenario: OpenAI flex service tier - lower rates applied for flex tier
    ...
    Given I generate a unique resource name from "cblp-openai-flex-provider" and store it as "providerName"
  ...
  Scenario: OpenAI priority service tier - higher rates applied for priority tier
    ...
    Given I generate a unique resource name from "cblp-openai-priority-provider" and store it as "providerName"
  ...
  Scenario: OpenAI batch service tier - batch rates applied for batch tier
    ...
    Given I generate a unique resource name from "cblp-openai-batch-provider" and store it as "providerName"
  ...
  Scenario: OpenAI reasoning tokens billed at standard output rate
    ...
    Given I generate a unique resource name from "cblp-openai-reasoning-provider" and store it as "providerName"
  ...
  Scenario: OpenAI web search tool - url_citation annotation adds flat per-call fee
    ...
    Given I generate a unique resource name from "cblp-openai-web-search-provider" and store it as "providerName"
  ...
  Scenario: Mistral - bare model name resolved and cost calculated correctly
    ...
    Given I generate a unique resource name from "cblp-mistral-provider" and store it as "providerName"
  ...
  Scenario: No model field in response - zero cost never triggers rate limit
    ...
    Given I generate a unique resource name from "cblp-no-model-provider" and store it as "providerName"
  ...
  Scenario: Bedrock Converse model is extracted from URL and cost is calculated
    ...
    Given I generate a unique resource name from "cblp-bedrock-provider" and store it as "providerName"
