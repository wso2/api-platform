...
Feature: Log Message Policy Integration Tests
  ...
  Scenario: Log request payload and headers
    ...
    And I send a "GET" request to "/log-req/v1.0.0/health" until status 200
    When I send a "POST" request to "/log-req/v1.0.0/test" with body:
      """
      {"message": "hello world"}
      """
  ...
  Scenario: Log response payload and headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-resp/v1.0.0/info" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log both request and response
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/log-both/v1.0.0/health" until status 200
    When I send a "POST" request to "/log-both/v1.0.0/test" with body:
      """
      {"test": "data", "count": 42}
      """
    Then the response status code should be 200
  ...
  Scenario: Log only request headers without payload
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-req-headers/v1.0.0/info" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log only response headers without payload
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-resp-headers/v1.0.0/info" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log only request payload without headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/log-req-payload/v1.0.0/health" until status 200
    When I send a "POST" request to "/log-req-payload/v1.0.0/test" with body:
      """
      {"payload": "test"}
      """
    Then the response status code should be 200
  ...
  Scenario: Log only response payload without headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-resp-payload/v1.0.0/info" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log request headers with exclusions
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-req-exclude/v1.0.0/info" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log response headers with exclusions
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-resp-exclude/v1.0.0/info" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log message policy combined with set-headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/log-combined/v1.0.0/test" until status 200
    Then the response status code should be 200
  ...
  Scenario: Log message with different HTTP methods
    ...
    Then the response status code should be 201
    # Test GET
    When I send a "GET" request to "/log-methods/v1.0.0/info" until status 200
    Then the response status code should be 200
    # Test POST
    When I send a "POST" request to "/log-methods/v1.0.0/echo" with body:
      """
      {"method": "POST"}
      """
    Then the response status code should be 200
    # Test PUT
    When I send a "PUT" request to "/log-methods/v1.0.0/echo" with body:
      """
      {"method": "PUT"}
      """
    Then the response status code should be 200
    # Test DELETE
    When I send a "DELETE" request to "/log-methods/v1.0.0/echo"
    Then the response status code should be 200
  ...
  Scenario: Log message with large request payload
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/log-large/v1.0.0/health" until status 200
    When I send a "POST" request to "/log-large/v1.0.0/test" with body:
      """
      {
