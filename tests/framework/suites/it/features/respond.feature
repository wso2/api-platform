...
Feature: Response policy behavior
  ...
  Scenario: Return simple 200 OK response with plain text body
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext1}/v1.0.0/test" until status 404
  ...
  Scenario: Return 201 Created with JSON body and headers
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext2}/v1.0.0/health" until status 404
  ...
  Scenario: Return 204 No Content with empty body
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext3}/v1.0.0/health" until status 404
  ...
  Scenario: Default status code is 200 when not specified
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext4}/v1.0.0/test" until status 404
  ...
  Scenario: Return 400 Bad Request error
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext5}/v1.0.0/health" until status 404
  ...
  Scenario: Return 401 Unauthorized error
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext6}/v1.0.0/health" until status 404
  ...
  Scenario: Return 403 Forbidden error
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext7}/v1.0.0/health" until status 404
  ...
  Scenario: Return 404 Not Found error
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext8}/v1.0.0/health" until status 404
  ...
  Scenario: Return 429 Too Many Requests
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext9}/v1.0.0/health" until status 404
  ...
  Scenario: Return 500 Internal Server Error
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext10}/v1.0.0/health" until status 404
  ...
  Scenario: Return 503 Service Unavailable (maintenance mode)
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext11}/v1.0.0/health" until status 404
  ...
  Scenario: Return 301 Moved Permanently redirect
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext12}/v1.0.0/health" until status 404
  ...
  Scenario: Return 302 Found temporary redirect
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext13}/v1.0.0/health" until status 404
  ...
  Scenario: Return XML response
    ...
    When I delete the API "${CTX:apiName14}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext14}/v1.0.0/test" until status 404
  ...
  Scenario: Return HTML response
    ...
    When I delete the API "${CTX:apiName15}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext15}/v1.0.0/test" until status 404
  ...
  Scenario: Return plain text response
    ...
    When I delete the API "${CTX:apiName16}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext16}/v1.0.0/test" until status 404
  ...
  Scenario: API mocking - return mocked user data
    ...
    When I delete the API "${CTX:apiName17}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext17}/v1.0.0/health" until status 404
  ...
  Scenario: Deprecated API endpoint notice
    ...
    When I delete the API "${CTX:apiName18}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext18}/v1.0.0/health" until status 404
  ...
  Scenario: Health check stub
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext19}/v1.0.0/health" until status 404
  ...
  Scenario: CORS preflight OPTIONS response
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext20}/v1.0.0/health" until status 404
  ...
  Scenario: Response with no body and no headers
    ...
    Then the response status code should be 200
    When I delete the API "${CTX:apiName21}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext21}/v1.0.0/test" until status 404
  ...
  Scenario: Response with empty body string
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext22}/v1.0.0/test" until status 404
  ...
  Scenario: Response with multiple custom headers
    ...
    When I delete the API "${CTX:apiName23}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext23}/v1.0.0/test" until status 404
  ...
  Scenario: Large JSON response body
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext24}/v1.0.0/test" until status 404
  ...
  Scenario: Response with special characters in body
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext25}/v1.0.0/test" until status 404
  ...
  Scenario: Return 206 Partial Content status code
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext26}/v1.0.0/health" until status 404
  ...
  Scenario: Return custom error code 418 I'm a teapot
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext27}/v1.0.0/health" until status 404
  ...
  Scenario: Return different response based on path but same policy
    ...
    When I delete the API "${CTX:apiName28}"
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext28}/v1.0.0/json" until status 404
  ...
  Scenario: Response with cache control headers
    ...
    Then the response should be successful
    And I send a "GET" request to "${CTX:apiContext29}/v1.0.0/static" until status 404
