...
Feature: Respond Policy Integration Tests
  ...
  Scenario: Return simple 200 OK response with plain text body
    ...
    When I send a "GET" request to "/respond-simple-200/v1.0.0/test" until status 200
  ...
  Scenario: Return 201 Created with JSON body and headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-201-json/v1.0.0/health" until status 200
    When I send a "POST" request to "/respond-201-json/v1.0.0/test" with body:
      """
      {"test": "data"}
      """
    Then the response status code should be 201
    And the JSON response field "name" should be "Created Resource"
  ...
  Scenario: Return 204 No Content with empty body
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-204-empty/v1.0.0/health" until status 200
    When I send a "DELETE" request to "/respond-204-empty/v1.0.0/test"
  ...
  Scenario: Default status code is 200 when not specified
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-default-200/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the response body should be:
      """
      Default response
  ...
  Scenario: Return 400 Bad Request error
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-400-error/v1.0.0/health" until status 200
    When I send a "POST" request to "/respond-400-error/v1.0.0/test" with body:
      """
      {"invalid": "data"}
      """
    Then the response status code should be 400
    And the JSON response field "error" should be "Bad Request"
    And the JSON response field "message" should be "Invalid input data"
  ...
  Scenario: Return 401 Unauthorized error
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-401-error/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-401-error/v1.0.0/test"
  ...
  Scenario: Return 403 Forbidden error
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-403-error/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-403-error/v1.0.0/test"
    Then the response status code should be 403
    And the JSON response field "error" should be "Forbidden"
    And the JSON response field "message" should be "Access denied to this resource"
  ...
  Scenario: Return 404 Not Found error
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-404-error/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-404-error/v1.0.0/test"
  ...
  Scenario: Return 429 Too Many Requests
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-429-ratelimit/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-429-ratelimit/v1.0.0/test"
    Then the response status code should be 429
    And the JSON response field "message" should be "Rate limit exceeded"
  ...
  Scenario: Return 500 Internal Server Error
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-500-error/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-500-error/v1.0.0/test"
    Then the response status code should be 500
    And the JSON response field "error" should be "Internal Server Error"
  ...
  Scenario: Return 503 Service Unavailable (maintenance mode)
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-503-maintenance/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-503-maintenance/v1.0.0/test"
    Then the response status code should be 503
    And the JSON response field "message" should be "System under maintenance. Please try again later."
  ...
  Scenario: Return 301 Moved Permanently redirect
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-301-redirect/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-301-redirect/v1.0.0/test"
  ...
  Scenario: Return 302 Found temporary redirect
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-302-redirect/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-302-redirect/v1.0.0/test"
  ...
  Scenario: Return XML response
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-xml/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the response body should be:
      """
      <?xml version="1.0"?><response><status>success</status><message>XML response</message></response>
      """
  ...
  Scenario: Return HTML response
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-html/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the response body should be:
      """
      <html><head><title>API Documentation</title></head><body><h1>Welcome</h1><p>This is a static HTML response.</p></body></html>
      """
  ...
  Scenario: Return plain text response
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-text/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the response body should be:
      """
      This is a plain text response with multiple lines.
      Line 2
      Line 3
      """
  ...
  Scenario: API mocking - return mocked user data
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-mock-user/v1.0.0/users/123" until status 200
    Then the response status code should be 200
    And the JSON response field "name" should be "John Doe"
    And the JSON response field "email" should be "john@example.com"
  ...
  Scenario: Deprecated API endpoint notice
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-deprecated/v1.0.0/health" until status 200
    When I send a "GET" request to "/respond-deprecated/v1.0.0/v1/users"
    Then the response status code should be 410
    And the JSON response field "message" should be "This endpoint is deprecated. Please use /v2/users instead."
    And the JSON response field "message" should be "This endpoint is deprecated. Please use /v2/users instead."
  ...
  Scenario: Health check stub
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-health/v1.0.0/health" until status 200
    Then the response status code should be 200
    And the JSON response field "status" should be "healthy"
  ...
  Scenario: CORS preflight OPTIONS response
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-cors/v1.0.0/health" until status 200
    When I send a "OPTIONS" request to "/respond-cors/v1.0.0/test"
    Then the response status code should be 204
  ...
  Scenario: Response with no body and no headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-minimal/v1.0.0/test" until status 200
    Then the response status code should be 200
  ...
  Scenario: Response with empty body string
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-empty-body/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the response should be empty
  ...
  Scenario: Response with multiple custom headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-multi-headers/v1.0.0/test" until status 200
    Then the response status code should be 200
  ...
  Scenario: Large JSON response body
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-large-json/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the JSON response field "users[0].name" should be "User 1"
    And the JSON response field "users[4].name" should be "User 5"
    And the JSON response field "total" should be 5
  ...
  Scenario: Response with special characters in body
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-special-chars/v1.0.0/test" until status 200
    Then the response status code should be 200
    And the JSON response field "message" should be:
      ...
      """
    And the JSON response field "emoji" should be "🎉✅❌"
  ...
  Scenario: Return 206 Partial Content status code
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-206-partial/v1.0.0/health" until status 200
    When I send a "POST" request to "/respond-206-partial/v1.0.0/test" with body:
      """
      {"test": "data"}
      """
    Then the response status code should be 206
    And the JSON response field "status" should be "Partial Content"
  ...
  Scenario: Return custom error code 418 I'm a teapot
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    And I send a "GET" request to "/respond-418-teapot/v1.0.0/health" until status 200
    When I send a "POST" request to "/respond-418-teapot/v1.0.0/brew-coffee" with body:
      """
      {"beverage": "coffee"}
      """
    Then the response status code should be 418
    And the JSON response field "error" should be "I am a teapot"
  ...
  Scenario: Return different response based on path but same policy
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-multi-path/v1.0.0/json" until status 200
    Then the response status code should be 200
    And the JSON response field "format" should be "json"
    When I send a "GET" request to "/respond-multi-path/v1.0.0/xml"
    Then the response status code should be 200
    And the response body should be:
      """
      <?xml version="1.0"?><response><format>xml</format></response>
      """
  ...
  Scenario: Response with cache control headers
    When I create API with configuration:
      ...
      """
    Then the response status code should be 201
    When I send a "GET" request to "/respond-cache/v1.0.0/static" until status 200
    Then the response status code should be 200
