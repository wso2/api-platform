...
wget https://github.com/wso2/api-platform/releases/download/gateway/v1.0.0-rc.2/wso2apip-api-gateway-1.0.0-rc.2.zip

# Unzip the downloaded distribution.
unzip wso2apip-api-gateway-1.0.0-rc.2.zip
