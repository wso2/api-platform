...
### 📄 [API.yaml Specification](concepts/api-yaml-specification.md)
Declarative API definition format for deploying APIs to the platform.

**Key Features**:
- Kubernetes-like CR style (but platform-agnostic)
- Support for REST, GraphQL, gRPC, AsyncAPI
