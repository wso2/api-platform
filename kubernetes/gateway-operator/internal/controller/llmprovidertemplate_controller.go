...
func NewLlmProviderTemplateReconciler(c client.Client, cfg *config.OperatorConfig, logger *slog.Logger, tracker *ResourceTracker) *LlmProviderTemplateReconciler {
