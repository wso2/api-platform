...
```bash
kubectl run curl-hello --rm -it --restart=Never --image=curlimages/curl -n apigateway-demo -- \
  curl -skS "https://legacy-gw-gateway-gateway-runtime.apigateway-demo.svc.cluster.local:8443/hello-normal/"
```
