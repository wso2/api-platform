...
func (h *SubscriptionPlanHandler) GetSubscriptionPlan(w http.ResponseWriter, r *http.Request) {
	...
	planHandle := r.PathValue("planHandle")
	if planHandle == "" {
...
func (h *SubscriptionPlanHandler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET "+constants.APIBasePath+"/subscription-plans/{planHandle}", h.GetSubscriptionPlan)
	mux.HandleFunc("PUT "+constants.APIBasePath+"/subscription-plans/{planHandle}", h.UpdateSubscriptionPlan)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/subscription-plans/{planHandle}", h.DeleteSubscriptionPlan)
}
