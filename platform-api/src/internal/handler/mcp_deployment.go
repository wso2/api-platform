...
func (h *MCPProxyDeploymentHandler) RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("POST "+constants.APIBasePath+"/mcp-proxies/{mcpProxyHandle}/deployments", h.DeployMCPProxy)
	mux.HandleFunc("POST "+constants.APIBasePath+"/mcp-proxies/{mcpProxyHandle}/deployments/{deploymentId}/undeploy", h.UndeployMCPProxyDeployment)
	mux.HandleFunc("POST "+constants.APIBasePath+"/mcp-proxies/{mcpProxyHandle}/deployments/{deploymentId}/restore", h.RestoreMCPProxyDeployment)
	mux.HandleFunc("GET "+constants.APIBasePath+"/mcp-proxies/{mcpProxyHandle}/deployments", h.GetMCPProxyDeployments)
	mux.HandleFunc("GET "+constants.APIBasePath+"/mcp-proxies/{mcpProxyHandle}/deployments/{deploymentId}", h.GetMCPProxyDeployment)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/mcp-proxies/{mcpProxyHandle}/deployments/{deploymentId}", h.DeleteMCPProxyDeployment)
}
...
func (h *MCPProxyDeploymentHandler) DeployMCPProxy(w http.ResponseWriter, r *http.Request) {
	...
	proxyId := r.PathValue("mcpProxyHandle")
	if proxyId == "" {
