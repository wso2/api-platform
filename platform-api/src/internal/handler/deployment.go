...
// DeployAPI handles POST /api/v1/rest-apis/:apiId/deployments
...
// DeleteDeployment handles DELETE /api/v1/rest-apis/:apiId/deployments/:deploymentId
...
// GetDeployment handles GET /api/v1/rest-apis/:apiId/deployments/:deploymentId
...
// GetDeployments handles GET /api/v1/rest-apis/:apiId/deployments
