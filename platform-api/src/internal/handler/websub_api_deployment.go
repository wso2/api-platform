...
func (h *WebSubAPIDeploymentHandler) RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("POST "+constants.APIBasePath+"/websub-apis/{apiHandle}/deployments", h.DeployWebSubAPI)
	mux.HandleFunc("POST "+constants.APIBasePath+"/websub-apis/{apiHandle}/deployments/{deploymentId}/undeploy", h.UndeployDeployment)
	mux.HandleFunc("POST "+constants.APIBasePath+"/websub-apis/{apiHandle}/deployments/{deploymentId}/restore", h.RestoreDeployment)
	mux.HandleFunc("GET "+constants.APIBasePath+"/websub-apis/{apiHandle}/deployments", h.GetDeployments)
	mux.HandleFunc("GET "+constants.APIBasePath+"/websub-apis/{apiHandle}/deployments/{deploymentId}", h.GetDeployment)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/websub-apis/{apiHandle}/deployments/{deploymentId}", h.DeleteDeployment)
}
