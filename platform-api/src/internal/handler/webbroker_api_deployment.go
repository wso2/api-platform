...
// UndeployDeployment handles POST /api/v1/webbroker-apis/:apiId/deployments/undeploy
...
// RestoreDeployment handles POST /api/v1/webbroker-apis/:apiId/deployments/restore
