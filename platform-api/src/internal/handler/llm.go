...
func (h *LLMHandler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}", h.GetLLMProviderTemplate)
	mux.HandleFunc("GET "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}/versions", h.ListLLMProviderTemplateVersions)
	mux.HandleFunc("GET "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}/versions/{version}", h.GetLLMProviderTemplateVersion)
	mux.HandleFunc("POST "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}/versions", h.CreateLLMProviderTemplateVersion)
	mux.HandleFunc("PATCH "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}/versions/{version}", h.SetLLMProviderTemplateVersionEnabled)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}/versions/{version}", h.DeleteLLMProviderTemplateVersion)
	mux.HandleFunc("PUT "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}", h.UpdateLLMProviderTemplate)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/llm-provider-templates/{templateHandle}", h.DeleteLLMProviderTemplate)
	...
	mux.HandleFunc("GET "+constants.APIBasePath+"/llm-providers/{providerHandle}", h.GetLLMProvider)
	mux.HandleFunc("GET "+constants.APIBasePath+"/llm-providers/{providerHandle}/llm-proxies", h.ListLLMProxiesByProvider)
	mux.HandleFunc("PUT "+constants.APIBasePath+"/llm-providers/{providerHandle}", h.UpdateLLMProvider)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/llm-providers/{providerHandle}", h.DeleteLLMProvider)
	...
	mux.HandleFunc("GET "+constants.APIBasePath+"/llm-proxies/{proxyHandle}", h.GetLLMProxy)
	mux.HandleFunc("PUT "+constants.APIBasePath+"/llm-proxies/{proxyHandle}", h.UpdateLLMProxy)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/llm-proxies/{proxyHandle}", h.DeleteLLMProxy)
}
...
func (h *LLMHandler) ListLLMProxiesByProvider(w http.ResponseWriter, r *http.Request) {
	...
	providerID := r.PathValue("providerHandle")
