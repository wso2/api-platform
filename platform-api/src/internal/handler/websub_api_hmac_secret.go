...
// CreateHmacSecret handles POST /api/v1/websub-apis/:apiId/hmac-secrets
...
// ListHmacSecrets handles GET /api/v1/websub-apis/:apiId/hmac-secrets
...
// DeleteHmacSecret handles DELETE /api/v1/websub-apis/:apiId/hmac-secrets/:secretName
...
// RegenerateHmacSecret handles POST /api/v1/websub-apis/:apiId/hmac-secrets/:secretName/regenerate
