...
type DevPortalHandler struct {
	devPortalManager *service.DevPortalManager
}

// NewDevPortalHandler creates a new DevPortalHandler
func NewDevPortalHandler(devPortalManager *service.DevPortalManager) *DevPortalHandler {
	return &DevPortalHandler{
		devPortalManager: devPortalManager,
	}
}
...
func (h *DevPortalHandler) CreateDevPortal(c *gin.Context) {
	...
	// Create DevPortal
	response, err := h.devPortalManager.CreateDevPortal(orgID, &req)
	if err != nil {
...
func (h *DevPortalHandler) GetDevPortal(c *gin.Context) {
	...
	// Get DevPortal
	response, err := h.devPortalManager.GetDevPortal(devPortalID, orgID)
	if err != nil {
...
func (h *DevPortalHandler) ListDevPortals(c *gin.Context) {
	...
	// List DevPortals
	response, err := h.devPortalManager.ListDevPortals(orgID, isDefault, isActive, limit, offset)
	if err != nil {
...
func (h *DevPortalHandler) UpdateDevPortal(c *gin.Context) {
	...
	// Update DevPortal
	response, err := h.devPortalManager.UpdateDevPortal(devPortalID, orgID, &req)
	if err != nil {
		if errors.Is(err, constants.ErrDevPortalNotFound) {
			c.JSON(http.StatusNotFound, utils.NewErrorResponse(404, "Not Found",
				"DevPortal not found"))
...
func (h *DevPortalHandler) DeleteDevPortal(c *gin.Context) {
	...
	// Delete DevPortal
	if err := h.devPortalManager.DeleteDevPortal(devPortalID, orgID); err != nil {
		if errors.Is(err, constants.ErrDevPortalNotFound) {
			c.JSON(http.StatusNotFound, utils.NewErrorResponse(404, "Not Found",
				"DevPortal not found"))
			return
...
func (h *DevPortalHandler) ActivateDevPortal(c *gin.Context) {
	...
	// Activate DevPortal
	response, err := h.devPortalManager.ActivateDevPortal(devPortalID, orgID)
	if err != nil {
		if errors.Is(err, constants.ErrDevPortalNotFound) {
			c.JSON(http.StatusNotFound, utils.NewErrorResponse(404, "Not Found",
				"DevPortal not found"))
		...
		if errors.Is(err, constants.ErrDevPortalSyncFailed) {
			c.JSON(http.StatusBadGateway, utils.NewErrorResponse(502, "Bad Gateway",
...
func (h *DevPortalHandler) DeactivateDevPortal(c *gin.Context) {
	...
	response, err := h.devPortalManager.DeactivateDevPortal(devPortalID, orgID)
	if err != nil {
		if errors.Is(err, constants.ErrDevPortalNotFound) {
			c.JSON(http.StatusNotFound, utils.NewErrorResponse(404, "Not Found",
				"DevPortal not found"))
...
func (h *DevPortalHandler) SetAsDefault(c *gin.Context) {
	...
	// Set as default
	if err := h.devPortalManager.SetAsDefault(devPortalID, orgID); err != nil {
		if errors.Is(err, constants.ErrDevPortalNotFound) {
			c.JSON(http.StatusNotFound, utils.NewErrorResponse(404, "Not Found",
				"DevPortal not found"))
			return
...
func (h *DevPortalHandler) GetDefaultDevPortal(c *gin.Context) {
	...
	response, err := h.devPortalManager.GetDefaultDevPortal(orgID)
	if err != nil {
		if errors.Is(err, constants.ErrDevPortalNotFound) {
			c.JSON(http.StatusNotFound, utils.NewErrorResponse(404, "Not Found",
