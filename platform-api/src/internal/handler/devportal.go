...
import (
	"log/slog"
	// "net/http"  // devportals table removed
	// "strconv"   // devportals table removed
	// "time"      // devportals table removed

	// "platform-api/src/api"               // devportals table removed
	// "platform-api/src/internal/middleware" // devportals table removed
...
func (h *DevPortalHandler) CreateDevPortal(c *gin.Context) {
	// devportals table removed — handler disabled
...
func (h *DevPortalHandler) ListDevPortals(c *gin.Context) {
	...
	// 	if defaultVal, err := strconv.ParseBool(defaultStr); err == nil { isDefault = &defaultVal }
	// }
	// if activeStr := c.Query("active"); activeStr != "" {
	// 	if activeVal, err := strconv.ParseBool(activeStr); err == nil { isEnabled = &activeVal }
	// }
...
func (h *DevPortalHandler) ActivateDevPortal(c *gin.Context) {
	...
	// c.JSON(http.StatusOK, api.CommonResponse{Success: true, Message: "DevPortal activated successfully", Timestamp: time.Now()})
}
...
func (h *DevPortalHandler) DeactivateDevPortal(c *gin.Context) {
	...
	// c.JSON(http.StatusOK, api.CommonResponse{Success: true, Message: "DevPortal deactivated successfully", Timestamp: time.Now()})
}
...
func (h *DevPortalHandler) SetAsDefault(c *gin.Context) {
	...
	// c.JSON(http.StatusOK, gin.H{"message": "DevPortal set as default successfully", "devPortalUuid": devPortalID})
}
...
func (h *DevPortalHandler) RegisterRoutes(r *gin.Engine) {
	// devportals table removed — all routes disabled
