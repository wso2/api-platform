...
func (h *WebSubAPIHandler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET "+constants.APIBasePath+"/websub-apis/{apiHandle}", h.GetWebSubAPI)
	mux.HandleFunc("PUT "+constants.APIBasePath+"/websub-apis/{apiHandle}", h.UpdateWebSubAPI)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/websub-apis/{apiHandle}", h.DeleteWebSubAPI)
	mux.HandleFunc("POST "+constants.APIBasePath+"/websub-apis/{apiHandle}/publications", h.PublishToDevPortal)
	mux.HandleFunc("DELETE "+constants.APIBasePath+"/websub-apis/{apiHandle}/publications/{devportalId}", h.UnpublishFromDevPortal)
}
