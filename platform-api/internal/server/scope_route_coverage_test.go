...
func registerAllRoutes(mux *http.ServeMux) {
	...
	handler.NewApplicationHandler(nil, nil, logger).RegisterRoutes(mux)
	...
	handler.NewAPIKeyHandler(nil, nil, logger).RegisterRoutes(mux)
	...
	handler.NewLLMProviderAPIKeyHandler(nil, nil, logger).RegisterRoutes(mux)
	handler.NewLLMProxyAPIKeyHandler(nil, nil, logger).RegisterRoutes(mux)
	handler.NewAPIKeyUserHandler(nil, nil, logger).RegisterRoutes(mux)
	...
	eghandler.NewWebSubAPIKeyHandler(nil, nil, nil, logger).RegisterRoutes(mux)
	...
	eghandler.NewWebBrokerAPIKeyHandler(nil, nil, nil, logger).RegisterRoutes(mux)
}
