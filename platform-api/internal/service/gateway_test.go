...
func TestValidateGatewayInput(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			functionalityType: constants.GatewayFunctionalityTypeRegular,
			wantErr:           true,
			errContains:       "at least one endpoint is required",
		},
		{
		...
		},
		{
			...
			endpoints:         []string{"https://ai.example.com"},
		...
		},
		{
			...
			endpoints:         []string{"https://events.example.com"},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := service.validateGatewayInput(tt.orgID, tt.gatewayName, tt.displayName, tt.endpoints, tt.functionalityType)
