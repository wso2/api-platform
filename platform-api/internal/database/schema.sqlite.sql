...
CREATE INDEX IF NOT EXISTS idx_documents_artifact ON documents(artifact_uuid, type);
CREATE UNIQUE INDEX IF NOT EXISTS uq_documents_artifact_handle ON documents(artifact_uuid, handle);
