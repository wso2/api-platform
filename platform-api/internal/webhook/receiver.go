...
type apiKeyService interface {
	...
	UpdateAPIKey(ctx context.Context, apiHandle, kind, orgID, keyName, userID string, keyAdmin, authorizedUpstream bool, req *api.UpdateAPIKeyRequest) error
	RevokeAPIKey(ctx context.Context, apiHandle, kind, orgID, keyName, userID string, keyAdmin, authorizedUpstream bool) error
}
