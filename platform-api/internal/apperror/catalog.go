...
var (
	...
	RESTAPIKeyNotFound                = def(CodeRESTAPIKeyNotFound, http.StatusNotFound, "The specified API key could not be found.")
	RESTAPIKeyForbidden               = def(CodeRESTAPIKeyForbidden, http.StatusForbidden, "You do not have permission to access this API key.")
)
