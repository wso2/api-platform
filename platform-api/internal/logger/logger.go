...
// filesystem path. It handles both a local build (".../platform-api/internal/...")
// and platform-api imported as a dependency (".../platform-api@v1.2.3/internal/...").
// The "internal/" prefix is dropped; other roots (cmd, platform, ...) are kept.
// Paths outside the platform-api module (e.g. other modules) are returned as-is.
func shortenSource(file string) string {
	const mod = "platform-api"
