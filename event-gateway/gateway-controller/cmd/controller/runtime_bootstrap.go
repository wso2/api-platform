...
// Copied from gateway-controller (core) cmd/controller/runtime_bootstrap.go —
// unexported helpers in package main can't be imported across module
// boundaries. Generic startup hydration for RestApi/Mcp/LlmProvider/LlmProxy
// kinds only (WebSubApi/WebBrokerApi are excluded here exactly as in core;
// this binary's own kinds don't need runtime-config bootstrap hydration).
package main
